import { LocalPulse } from '../src/local-pulse';
import { Message, Payload } from '../src/types';

describe('LocalPulse', () => {
  let pulse: LocalPulse;
  ...
  beforeEach(() => {
    pulse = new LocalPulse(testCategory, testEvents);
  });
  ...
  describe('constructor', () => {
    ...
    it('should initialize with empty events if none provided', () => {
      const emptyPulse = new LocalPulse(testCategory);
  ...
  describe('startListening', () => {
    ...
    it('should handle asynchronous responses', async () => {
      ...
      const asyncPulse = new LocalPulse(testCategory, asyncEvents);
